...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "就绪"),
        ("Established", "已建立"),
        ("connecting_status", "正在接入 连议宝 网络..."),
        ("Enable service", "允许服务"),
        ("Start service", "启动服务"),
        ("Service is running", "连议宝正在运行"),
        ("Service is not running", "连议宝未运行"),
       ...
       ("ID/Relay Server", "ID/中继服务器"),
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "你正在运行未安装版本，由于 UAC 限制，作为被控端，会在某些情况下无法控制鼠标键盘，或者录制屏幕，请点击下面的按钮将 连议宝 安装到系统，从而规避上述问题。"),
        ("Click to upgrade", "点击这里升级"),
        ("Click to download", "点击这里下载"),
        ("Click to update", "点击这里更新"),
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的桌面, 请给予 连议宝 \"辅助功能\" 权限。"),
        ("config_screen", "为了能够远程访问你的桌面, 请给予 连议宝 \"屏幕录制\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
      ...
      ("Screen Capture", "开始接入"),
        ...
        ("How to get Android input permission?", "如何获取连议宝的网络加密？"),
       ("android_input_permission_tip1", "你需要允许 连议宝 使用\"无障碍\"服务。"),
        ("android_input_permission_tip2", "请在接下来的系统设置页面里，找到并进入 [已安装的服务] 页面，将 [连议宝] 服务开启。"),
       ...
       ("android_start_service_tip", "点击启动连议宝按钮，即可接入连议宝"),
        ...
        ("Turned off", "退出"),
        ("Language", "语言"),
        ("Keep RustDesk background service", "保持 连议宝 后台服务"),
        ("Ignore Battery Optimizations", "忽略电池优化"),
        ("android_open_battery_optimizations_tip", "如需关闭此功能，请在接下来的 连议宝 应用设置页面中，找到并进入 [电源] 页面，取消勾选 [不受限制]"),
        ("Start on boot", "电池优化"),
        ...
        ("config_input", "为了能够通过键盘控制远程桌面, 请给予 连议宝 \"输入监控\" 权限。"),
        ("config_microphone", "为了支持通过麦克风进行音频传输，请给予 连议宝 \"录音\"权限。"),
        ...
        ("still_click_uac_tip", "依然需要被控端用户在运行 连议宝 的 UAC 窗口点击确认。"),
        ...
        ("{} sessions", "{} 个会话"),
        ("scam_title", "你可能被骗了！"),
        ("scam_text1", "如果你正在和素不相识的人通话，而对方要求你使用 连议宝 启动服务，请勿继续操作并立刻挂断电话。"),
        ...
        ("allow-only-conn-window-open-tip", "仅当 连议宝 窗口打开时允许连接"),
        ...
        ("Floating window", "悬浮窗"),
        ("floating_window_tip", "有助于保持 连议宝 后台服务"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "请在远程端将 连议宝 客户端升级至版本 {} 或更新版本！"),
